...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		print("computerscreen size",screen_width,screen_height,"outputwindowsize",width,height)
		print("mouseposition",mouse.position,"tipslinecenterposition",center_x,center_y)
		
		relativemousex=(center_x/width)*screen_width
		relativemousey=(center_x/height)*screen_height
